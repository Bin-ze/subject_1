...
classes = ('caodi', 'shuinidi', 'mubandi', 'louti', 'xiepo', 'shadi', 'eluanshidi')
img_norm_cfg = dict(
...
evaluation = dict(save_best='auto', interval=5, metric=['bbox', 'segm'])

# NOTE: `auto_scale_lr` is for automatically scaling LR,
# USER SHOULD NOT CHANGE ITS VALUES.
# base_batch_size = (1 GPUs) x (8 samples per GPU)
auto_scale_lr = dict(base_batch_size=8)
#load_from = '/mnt/data/guozebin/subject_1/subject_1/checkpoints/yolact_r50_1x8_coco_20200908-f38d58df.pth'