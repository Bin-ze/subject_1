...
class Inference:
    def __init__(self, config, checkpoint, save_path, device, conf):
        ...
        # TODO sub2
        self.detection_names = ('dibiao', '长凳', '桌子', '小石头', 'zhangaiwu', '木门槛', '椅子', '砖头')
        self.segmentation_names = ('草地', '水泥地', 'mubandi', '楼梯', '斜坡', '山地', '鹅卵石地面')
        ...
        # TODO Sub2
        path_att_all = './Knowledge/Attribute_triplet_dict_new_t8.json'
        path_Text_triplet = './Knowledge/Text_visualization_triplet3.json'
        path_Scene_triplet = './Knowledge/Scene_triplet-3.json'
    ...
    def sub2_callback5(self, data):
        ...
        if data and data != []:
            ...
            # print('class_name_list2:', class_name_list2)
            class_name_list3 = []  #
            ...
            object_all = []
            object_all2 = []
            print('class_name_list3', class_name_list3)
            for str_obj in class_name_list3:
                attribute_value, triplet_value, scene_value = self.attribute_retrieve(str_obj)  # 返回列表
    ...
    def sub2_listener(self, det_bboxes, det_labels, seg_labels, seg_bboxes): # 收到数据
    
        flag = 0
    
        both_label = [] # 类别
        both_label.append(det_labels)
        both_label.append(seg_labels)

        both_bboxes = [] # 框坐标
        both_bboxes.append(det_bboxes)
        both_bboxes.append(seg_bboxes)

        data_dict = {}
        data_dict['类别'] = both_label
        data_dict['框坐标'] = both_bboxes
    ...
    def __call__(self, input_image, plot=True):
        ...
        # TODO sub2
        object_all = self.sub2_listener(det_bboxes, det_labels, seg_labels, seg_bboxes)
